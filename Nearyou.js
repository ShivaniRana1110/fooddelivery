...
export default function northfood() {
    const handleSubmit=async(e)=>{
        e.preventDefault();
        const response = await fetch("http://localhost:5000/api/nearyou",{
        method:'POST',
        headers:{
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="image-container">
          ...
          <div class="text-container">
            <p>
            <Link to="/sizzleandstir" className="image-container"> <h3>Sizzle And Stir</h3></Link>
      ...
      <div class="col-md-4">
        <div class="image-container">
          ...
          <div class="text-container">
            <p>
            <Link to="/platterperfection" className="image-container"> <h3>Platter Perfection</h3></Link>
