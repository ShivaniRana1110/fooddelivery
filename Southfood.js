...
export default function chinesefood() {
    const handleSubmit=async(e)=>{
        e.preventDefault();
        const response = await fetch("http://localhost:5000/api/southfood",{
        method:'POST',
        headers:{
    ...
    return (
      ...
      <div class="container mt-5">
        <h1>SOUTH INDIAN</h1>
        <h3>The Essence Of Delicious India.</h3>
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <div class="image-container">
          ...
          <div class="text-container">
            <p>
            <Link to="/annaskitchen" className="image-container"> <h3>Anna's Kitchen </h3></Link>
